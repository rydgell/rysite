...
import com.ry.site.common.security.Digests;
import com.ry.site.common.security.shiro.session.SessionDAO;
import com.ry.site.common.service.BaseService;
import com.ry.site.common.service.ServiceException;
import com.ry.site.common.utils.CacheUtils;
import com.ry.site.common.utils.Encodes;
import com.ry.site.common.utils.StringUtils;
import com.ry.site.common.web.Servlets;
...
import com.ry.site.modules.sys.security.SystemAuthorizingRealm;
import com.ry.site.modules.sys.utils.LogUtils;
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	@Transactional(readOnly = false)
	public void assignUserToRole(Role role,List<String> userIds) {
		...
		for(User u:userList){
			UserUtils.clearCache(u); //清除缓存
		}
		roleDao.deleteRoleUsers(role);
	...
	public void saveMenu(Menu menu) {
		...
		UserUtils.removeCache(UserUtils.CACHE_MENU_LIST_);
//		// 清除权限缓存
//		systemRealm.clearAllCachedAuthorizationInfo();
		// 清除日志相关缓存
